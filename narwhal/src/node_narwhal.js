(function (modules) {
    ...
    function main () {
        var text = modules.file.read(modules.system.prefix + "/narwhal.js");
        var factory = modules.system.compile(text, "narwhal.js", 1);
        factory(modules);
    }
    ...
    (function (exports) {
        ...
        exports.print = function () {
            modules['node/stdio'].stdio.write(Array.prototype.join.call(arguments, " ") + "\n");
            return exports;
        };
    ...
    // module "file"
    (function (exports) {
        var k = modules['node/constants'];
        var fs = modules['node/file'];
        ...
        exports.read = function (path) {
            ...
            try {
                ...
                var pos = 0;
                do {
                    var chunk = fs.read(fd, 1024, pos, "utf8");
                    chunks.push(chunk);
                    pos += chunk.length;
                } while (chunk.length);
                return chunks.join("");
